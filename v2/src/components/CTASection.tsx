  ...
  return (
    <section ref={sectionRef} className="py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          ref={contentRef}
          className="card-dark p-10 md:p-16 text-center relative overflow-hidden"
          style={{ opacity: 0 }}
        >
          {/* Background glow */}
          <div 
            ...
            style={{
              background: 'radial-gradient(circle at 50% 50%, rgba(249, 115, 22, 0.2) 0%, transparent 60%)',
            }}
          />
          ...
          <div className="relative z-10">
            <h2 className="headline-section mb-4">
              Stop Editing.{' '}
              <span className="text-flamma-bright">Start Growing.</span>
            </h2>
