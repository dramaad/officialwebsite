      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1
            ...
            style={{ opacity: 0 }}
          >
            Turn <span className="text-flamma-soft">Raw Footage</span> into{' '}
            <span className="text-flamma-bright glow-text">Winning Ads</span>
            <br />
          ...
          >
            <div className="process-bar">
              ...
              <span className="text-flamma-bright font-semibold tracking-wider">REVENUE OUT</span>
            </div>
          </div>
        </div>
      </div>
